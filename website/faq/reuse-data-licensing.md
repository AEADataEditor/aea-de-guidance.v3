...
Migrated deposits are (&copy; AEA), newer deposits remain copyrighted by the original authors (unless otherwise stated in the deposit's LICENSE file). Most deposits are under a [mixed CC-BY/BSD](/LICENSE-template) license, or under a [CC-BY](https://creativecommons.org/licenses/by/4.0/) license. 
